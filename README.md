...
一面：基础概念的了解情况，简历的了解，问了C++的基础知识，设计模式知道哪些，工厂模式说一下；智能指针自己实现的话怎么做，口述一下；轻量网络模型的指标；softmax怎么做的，后面loss怎么算（交叉熵）；过拟合怎么办；除了BN还有的归一化操作有了解吗；softmax的变种知道吗；GCNv2的pixel shuttle是怎么做的；
